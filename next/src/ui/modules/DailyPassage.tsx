    ...
    <>
      ...
      {calendarData && (
        <div className="mx-auto max-w-7xl md:px-6 lg:px-8">
            ...
            <dl className="my-8 max-w-xl space-y-3 text-base leading-7 text-gray-600 lg:max-w-none">
              {calendarData.stories.map((story, index) => (
                <div key={index} className="relative">
                  <dt
                    className={`block font-semibold hover:text-red-700/80 ${currentSaintIndex === index ? 'text-red-900/80' : 'text-slate-800'}`}
          ...
          <div className="relative py-8 mx-auto sm:rounded-3xl sm:pt-16 min-h-screen">
